...
# Replace 'COMx' with your Bluetooth COM port number on the laptop
# or the appropriate device file on Linux like '/dev/rfcomm0'
bluetooth = serial.Serial(port='/dev/rfcomm0', baudrate=9600, timeout=1)
...
def calculate_openness(current_distances, open_distances, close_distances):
    # Calculate openness percentage for each finger
